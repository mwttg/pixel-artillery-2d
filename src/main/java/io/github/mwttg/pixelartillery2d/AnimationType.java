...
public enum AnimationType {
    ...
    /**
     * Plays the Sprite animation only once. After that the last frame of the animation is
     * rendered (like a static Sprite)
     */
    ONCE,

    /**
     * Plays the Sprite animation from start to end. Once the end is reached the animation is
     * played from end to start. After that the process repeats.
     */
    ALTERNATING
}
